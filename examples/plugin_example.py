...
def main():
    ...
    # Register plugins
    # client.register_plugin(SecurityPlugin(customer_encryption_key_arn="your-kms-key-arn"))
    # client.register_plugin(GuardrailPlugin(guardrail_id="your-guardrail-id"))
    # client.register_plugin(KnowledgeBasePlugin(knowledge_base_id="your-kb-id"))
    client.register_plugin(LoggingPlugin(log_file="api_calls.log"))
